...
class VehicleDocument(models.Model):
    ...
    vehicle_model_id = fields.Many2one(related='vehicle_id.model_id', string="Jenis Kendaraan", store=True, readonly=True)
    pengguna = fields.Char(related='vehicle_id.user', string="Pengguna", store=True, readonly=True)
    vehicle_year = fields.Char(related='vehicle_id.year', string="Tahun", store=True, readonly=True)
